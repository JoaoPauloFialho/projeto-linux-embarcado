#ifndef FONT8X8_OLED_H
#define FONT8X8_OLED_H

// Fonte ASCII (32 ao 127) mapeada nativamente em Colunas Verticais para OLED I2C
const unsigned char font8x8_oled[96][8] = {
    ...
    {0x00, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x00}, // 92 contrabarra
